...
import { GOAL_OFFSET, FIREWORK_PARTICLE_COUNT, GRAVITY, CELEBRATION_TEXT, CELEBRATION_FONT, CELEBRATION_COLOR, CELEBRATION_STROKE_COLOR, HARU_URARA_NAME, HARU_WIN_MESSAGE, CUTIN_DURATION } from "./constants";
