...
export class Horse {
    ...
    position: number = 0;
    speed: number;
    isAwakened: boolean = false; // 覚醒状態フラグ
    isSelected: boolean = false; // 選択状態フラグ

    private baseSpeed: number;
    private accelerationPower: number;
     ...
     */
    constructor(name: string, color: string, lane: number, type: HorseType, baseSpeed: number, accelerationPower: number, isPlayer: boolean = false) {
        this.name = name;
        this.color = color;
        this.lane = lane;
        this.type = type;
