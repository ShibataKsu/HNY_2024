...
import { GOAL_OFFSET, FIREWORK_PARTICLE_COUNT, GRAVITY, CELEBRATION_TEXT, CELEBRATION_FONT, CELEBRATION_COLOR, CELEBRATION_STROKE_COLOR, CUTIN_DURATION } from "./constants";
/**
 * レース自体を管理します。
 */
export class Race {
